...
import com.factory.appraisal.factoryService.services.ShipmentService;
import com.factory.appraisal.factoryService.services.impl.EmailServiceImpl;
...
@Api(tags = "Shipment", value = "Shipment Module")
public class ShipmentController {
     ...
     * @return   CardsPage
     */
    @ApiOperation(value = "get My Sold car cards by user id and dealer id", response = CardsPage.class)
     ...
     * @return   CardsPage
     */
    @ApiOperation(value = "get My purchase car cards by user id and dealer id", response = CardsPage.class)
    ...
    public ResponseEntity<Resource>  facSaleRepPdf(@RequestParam Long fsUserId) throws JRException, IOException {
    ...
    public  ResponseEntity<Resource> facMngRepPdf(@RequestParam Long fmUserId) throws JRException, IOException {
    ...
    public ResponseEntity<Resource> genTrnsReport(@RequestParam("userId") Long userId,@RequestParam String start, @RequestParam String end) throws IOException, TemplateException, JRException, JDOMException, ParseException {
    ...
    public ResponseEntity<TableList> transacList(@RequestHeader("userId") Long userId,@RequestParam Integer pageNo, @RequestParam Integer pageSize,@RequestParam String start, @RequestParam String end) throws ParseException {
    ...
    @ApiOperation(value = "get all records of Appraisals", response = TableList.class)
    ...
    @ApiOperation(value = "get total members", response = TableList.class)
    ...
    public ResponseEntity<TableList> membersListPage(@RequestParam Integer pageNo, @RequestParam Integer pageSize) {
     ...
     @ApiOperation(value = "get total members of salesman", response = TableList.class)
     @PostMapping("/getSalesManMembers")
     public ResponseEntity<TableList> salesManMembersListPage(@RequestParam Long fsUserId,@RequestParam Integer pageNo, @RequestParam Integer pageSize) {
        TableList tableList = pdfGenerator.salesManMemReport(fsUserId,pageNo, pageSize);
        return new ResponseEntity<>(tableList, HttpStatus.OK);
     }
     @ApiOperation(value = "get total members of manager", response = TableList.class)
     @PostMapping("/getManagerMembers")
     public ResponseEntity<TableList> managersMembersListPage(@RequestParam Long fmUserId,@RequestParam Integer pageNo, @RequestParam Integer pageSize) {
