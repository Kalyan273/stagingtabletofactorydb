...
import com.factory.appraisal.factoryService.Mapper.AppraisalConfigMapper;
...
public class AppraiseVehicleServiceImpl implements AppraiseVehicleService {
    ...
    public Response oneAppraiseVehicle(EInventoryVehicles apprCreaPage, UUID userId) throws AppraisalException {
        ...
        creaPages = appraisalVehicleMapper.invToApprCreaPage(apprCreaPage);

        creaPages = setColors(creaPages, apprCreaPage.getExteriorColor(), apprCreaPage.getInteriorColor());

        List<String> allPics = new ArrayList<>();
        allPics.add(apprCreaPage.getVehiclePic1());
        allPics.add(apprCreaPage.getVehiclePic2());
        allPics.add(apprCreaPage.getVehiclePic3());
        allPics.add(apprCreaPage.getVehiclePic4());
        allPics.add(apprCreaPage.getVehiclePic5());
        allPics.add(apprCreaPage.getVehiclePic6());
        allPics.add(apprCreaPage.getVehiclePic7());
        allPics.add(apprCreaPage.getVehiclePic8());
        allPics.add(apprCreaPage.getVehiclePic9());
        creaPages = setMedia(allPics, creaPages);
//        creaPages.setFromMkt("YES");

        Response response = addAppraiseVehicle(creaPages, userId, AppraisalConstants.INVENTORY);
        return response;
    ...
    public Response addAppraiseVehicle(ApprCreaPage apprCreaPage, UUID userId,String apprStatus) throws AppraisalException {
            ...
            if (null != user) {
                ...
                eAppraiseVehicle.setInvntrySts(AppraisalConstants.INVENTORY);
    ...
    public CardsPage  findAllAppraisalCards(UUID userId, Integer pageNumber, Integer pageSize) throws AppraisalException {
        ...
        //List<Long> allUsersUnderDealer = dealersUser.getAllUsersUnderDealer(userId);

        Page<EAppraiseVehicle> pageResult = eAppraiseVehicleRepo.appraisalCards(userId, true,pageable);

      //  Page<EAppraiseVehicle> pageResult = eAppraiseVehicleRepo.allAppraisalCards(allUsersUnderDealer, true,pageable);
    ...
    @Override
    public ApprCreaPage showInEditPage(Long appraisalId) throws AppraisalException, JRException, IOException, JDOMException {
    ...
    private void keyassureFileCheck(Long appraisalId) throws JRException, IOException, JDOMException {
        ...
        if (null!=appraisalById){
            ...
            if (appraisalById.getTdStatus().getKeyAssureYes().equalsIgnoreCase("yes")&&appraisalById.getTdStatus().getKeyAssureFiles()==null) {
    ...
    @Override
    public Response moveToWishList(Long apprRef,Long userId) throws AppraisalException {
        Response response=new Response();
        ...
        EUserWishlist userWish=new EUserWishlist();
            if (wishList!=null){
                ...
                userWish.setUser(userRegistrationRepo.getOne(userId));
    ...
    @Override
    public CardsPage findFavoriteVehicle(Long userId, Integer pageNumber, Integer pageSize) throws AppraisalException {
        CardsPage pageInfo=new CardsPage();
    ...
    @Override
    public Response removeVehicleFromFavoritePage(Long apprRef, Long userId) throws AppraisalException {
        Response response=new Response();
    ...
    public String transferFile(String file) throws IOException {
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            for (String imageName:fileName) {
                ...
                PutObjectRequest request=new PutObjectRequest("images",imageName, inputStream,null);
